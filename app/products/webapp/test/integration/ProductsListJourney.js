...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheProductsList.onTable().iCheckColumns(5, {"image/content":{"header":"Preview"},"title":{"header":"Product Name"},"price":{"header":"Unit Price"},"stock":{"header":"Current Stock"},"vendor/name":{"header":"Supplier"}});
